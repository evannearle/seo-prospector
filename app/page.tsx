...
type TabId = 'prospector' | 'leads' | 'phone' | 'analytics'
...
export default function Home() {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100vh',overflow:'hidden',background:'#f6f6f4'}}>
      <div style={{display:'flex',alignItems:'stretch',background:'#fff',borderBottom:'1px solid #e4e4e0',padding:'0 20px',gap:0,flexShrink:0}}>
      ...
      <div style={{flex:1,overflow:'hidden',position:'relative'}}>
        ...
        {active==='leads' && <div style={{display:'flex',height:'100%'}}><LeadsTab onSendToPhone={(ids)=>{setPhoneQueue(q=>[...new Set([...q,...ids])]);setActive('phone')}} /></div>}
