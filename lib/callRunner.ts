...
function buildConfig(): Record<string, any> {
  ...
  try {
    ...
    return {
      ...
      voiceProvider:           raw.voiceProvider || 'vapi',
      voiceSpeed:              raw.voiceSpeed ?? 1.1,
      voiceStability:          raw.voiceStability ?? 0.45,
      voiceSimilarityBoost:    raw.voiceSimilarityBoost ?? 0.75,
      voiceOptimizeLatency:    raw.voiceOptimizeLatency ?? 3,
      maxCallDurationSeconds:  raw.maxCallDurationSeconds || 600,
      voiceId:                 raw.voiceId || 'elliot',
